defmodule FullstackChallengeWeb.TransactionController do
  use FullstackChallengeWeb, :controller

  alias FullstackChallenge.Transactions
  alias FullstackChallenge.Transactions.Transaction

  action_fallback FullstackChallengeWeb.FallbackController
